...
class Archer(Tk):
    def __init__(self, *args, **kwargs):
        ...
        for F in (Home, Admin, Login, SMS, Email, Weather, Mood, Journal, Personal, Exercise, Meds, ToDo, Encryption, Decryption):
...
class Mood(Frame):
    def __init__(self, parent, controller):
        ...
        # Entry's
        self.anxiety = ttk.Entry(self, width=45, font=LARGE_FONT)
        self.anger = ttk.Entry(self, width=45, font=LARGE_FONT)
        self.down = ttk.Entry(self, width=45, font=LARGE_FONT)
        self.sad = ttk.Entry(self, width=45, font=LARGE_FONT)
        self.unknown = ttk.Entry(self, width=45, font=LARGE_FONT)
        self.summary = Text(self, width=50, height=3, font=LARGE_FONT)

        # Labels
        self.anxiety_label = ttk.Label(self, text="Anxiety", font=LARGE_FONT)
        self.anger_label = ttk.Label(self, text="Anger", font=LARGE_FONT)
        self.down_label = ttk.Label(self, text="Down", font=LARGE_FONT)
        self.sad_label = ttk.Label(self, text="Sad", font=LARGE_FONT)
        self.unknown_label = ttk.Label(self, text="Unknown", font=LARGE_FONT)
        self.summary_label = ttk.Label(self, text="Summary", font=LARGE_FONT)

        # Buttons
        self.commitData = ttk.Button(self, text="Commit Data", command=self.moodData, width=22)
        self.back = ttk.Button(self, text="Back to admin", command=lambda: controller.show_frame(Admin), width=22)

        # Placements
        self.anxiety_label.place(x=380, y=290)
        self.anxiety.place(x=505, y=290)

        self.anger_label.place(x=370, y=340)
        self.anger.place(x=505, y=340)

        self.down_label.place(x=380, y=390)
        self.down.place(x=505, y=390)

        self.sad_label.place(x=380, y=440)
        self.sad.place(x=505, y=440)

        self.unknown_label.place(x=380, y=490)
        self.unknown.place(x=505, y=490)

        self.summary_label.place(x=220, y=560)
        self.summary.place(x=405, y=560)

        self.commitData.place(x=550, y=640)
    ...
    def moodData(self):
        ...
        self.anxiety.delete(0, END)
        self.anger.delete(0, END)
...
class Meds(Frame):
    def __init__(self, parent, controller):
        ...
        # Title
        self.title = ttk.Label(self, text="Med Data", font=LARGE_FONT)
        self.title.pack()
        ...
        # Entry's
        self.morning = ttk.Entry(self, width=22, font=LARGE_FONT)
        self.afternoon = ttk.Entry(self, width=22, font=LARGE_FONT)
        self.evening = ttk.Entry(self, width=22, font=LARGE_FONT)
        self.night = ttk.Entry(self, width=22, font=LARGE_FONT)

        # Labels
        self.morning_label = ttk.Label(self, text="Morning", font=LARGE_FONT)
        self.afternoon_label = ttk.Label(self, text="Afternoon", font=LARGE_FONT)
        self.evening_label = ttk.Label(self, text="Evening", font=LARGE_FONT)
        self.night_label = ttk.Label(self, text="Night", font=LARGE_FONT)

        # Buttons
        self.morning_button = ttk.Button(self, text="Commit Morning", command=self.addMorning, width=22)
        self.afternoon_button = ttk.Button(self, text="Commit Afternoon", command=self.addAfternoon, width=22)
        self.evening_button = ttk.Button(self, text="Commit Evening", command=self.addEvening, width=22)
        self.night_button = ttk.Button(self, text="Commit Night", command=self.addNight, width=22)
        self.back = ttk.Button(self, text="Back to admin", command=lambda: controller.show_frame(Admin), width=22)

        # Placements
        self.morning_label.place(x=360, y=260)
        self.morning.place(x=505, y=260)
        self.morning_button.place(x=560, y=290)

        self.afternoon_label.place(x=360, y=330)
        self.afternoon.place(x=505, y=330)
        self.afternoon_button.place(x=560, y=360)

        self.evening_label.place(x=360, y=410)
        self.evening.place(x=505, y=410)
        self.evening_button.place(x=560, y=440)

        self.night_label.place(x=360, y=480)
        self.night.place(x=505, y=480)
        self.night_button.place(x=560, y=510)
    ...
    def addMorning(self):
        ...
        stmt1 = f"INSERT INTO archer.meds (date_) VALUE ('{str(date.today())}')"

        stmt2 = f"""UPDATE archer.meds SET morning='{self.morning.get() + ' ' + self.systemTime}' WHERE date_='{str(date.today())}'"""
    ...
    def addAfternoon(self):
        ...
        stmt = f"UPDATE archer.meds SET afternoon='{self.afternoon.get() + ' ' + self.systemTime}' WHERE date_='{str(date.today())}'"
    ...
    def addEvening(self):
        ...
        stmt = f"UPDATE archer.meds SET evening='{self.evening.get() + ' ' + self.systemTime}' WHERE date_='{str(date.today())}'"
    ...
    def addNight(self):
        ...
        stmt = f"UPDATE archer.meds SET night='{self.night.get() + ' ' + self.systemTime}' WHERE date_='{str(date.today())}'"
